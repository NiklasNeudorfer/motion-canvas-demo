...
export default makeScene2D(function* (view) {
    ...
    view.add(
        <Node ref={chatGroup}>
            ...
            <Rect
                ...
                smoothCorners
                radius={[40, 0, 40, 40]}>
                <Txt x={40} width={() => userMsg1().width()} fill={"white"} fontSize={40}>Hallo Leonie!</Txt>
                <Polygon
                    x={() => userMsg1().width() / 2}
            ...
            <Rect
                ...
                <Rect
                    ...
                    <Rect
                        ...
                        radius={[40, 0, 40, 40]}>
                        <Txt x={40} width={() => userMsg1().width()} fill={"white"} fontSize={40}>Hallo Leonie!</Txt>
                        <Txt x={160} y={80} width={() => userMsg1().width()} fill={"grey"} fontSize={35}>greet -
                            91.73%</Txt>
                        <Polygon
                            x={() => userMsg1().width() / 2}
                            y={() => userMsg1().height() / -2 + 13}
    ...
    yield* chatRef().text('Hallo Leonie!', 1.5, easeInCubic);
